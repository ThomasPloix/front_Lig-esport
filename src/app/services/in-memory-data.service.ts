...
export class InMemoryDataService implements InMemoryDbService {
    createDb() {
        const regions: Region[] = [
            { id: 1, name: 'LEC', logourl: 'https://static.wikia.nocookie.net/lolesports_gamepedia_en/images/3/30/LEC_2023.png', teams: ["FNC","G2","MAD","KC"],competitions: ["Regular Season", "Playoffs"] },
